...
namespace RayFire
{
    ...
    public class RayfireConnectivity : MonoBehaviour
    {
        ...
        [Range (0, 1f)] public float expand;
        ...
        //[NonSerialized]   public bool integrityCheck  = false;
        ...
        [HideInInspector] public RayfireRigidRoot   rigidRootHost;
        [HideInInspector] public RayfireRigid       meshRootHost;
